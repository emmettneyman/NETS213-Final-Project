...
numOfQueriesToGenerate = int(sys.argv[2]);
queryNum = 0
...
outputFile = open('simulated_data/query_cluster.simulated.csv','w')
...
while queryNum < numOfQueriesToGenerate:
    queryTitle = output.keys()[randint(0, len(output.keys()) - 1)]
    queryBody = output[queryTitle]
