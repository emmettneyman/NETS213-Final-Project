...
fields = ['Title', 'Body']
enteredValues = multenterbox('Enter your post:','PiazzaPal', fields)
queryTitle = enteredValues[0]
queryBody = enteredValues[1] 
...
outputStr = ""
outputStr += "You are not as original as you may think...check out some similar questions below:\n"
outputStr += "Matched words: " + ",".join(matchedCluster['words']) + '\n'
...
for title in matchedCluster['titles']:
    ...
    if title != queryTitle:
        resultNum += 1
        outputStr += 'Question' + str(resultNum) + ': ' + title + '\n'
codebox(outputStr)
